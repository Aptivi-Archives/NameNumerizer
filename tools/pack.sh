...
# Pack binary
echo Packing binary...
"$rarpath" a -ep1 -r -m5 /tmp/$version-bin.rar "../NameNumerizer.Core/bin/$releaseconf/netstandard2.0/"
"$rarpath" a -ep1 -r -m5 /tmp/$version-demo.rar "../NameNumerizer/bin/$releaseconf/net6.0/"
if [ ! $? == 0 ]; then
